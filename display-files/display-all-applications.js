...
const SearchResult = function(props) {
  ...
  return React.createElement(
    ...
    React.createElement("h3", { className: "applicant-name" }, service.name),
    ...
    React.createElement("p", { className: "applicant-service" }, service.date),
    React.createElement("p", { className: "applicant-service" }, service.time)
  );
};
...
const application_page_display = function(props) {
  ...
  return React.createElement(
    ...
    React.createElement('a', { href: '?service=MJC Math and Engineering Club' }, ""),
